...
import random
import numpy as np
from .aaa_update import update_input_embeds_ids_masks_labels
...
class Qwen2_5_VLModel(Qwen2_5_VLPreTrainedModel):
    ...
    def update_position_ids(self, position_ids, grid_txy_list):
        """
    ...
    def forward(
        ...
        if inputs_embeds is None:
            ...
            if pixel_values is not None:
                ...
                position_ids = self.update_position_ids(position_ids=position_ids,grid_txy_list=grid_txy_list)
